...
const DitherVeil = ({
  ...
  useEffect(() => {
    ...
    const eventTarget = targetRef?.current || container;
    ...
    eventTarget.addEventListener('pointercancel', onLeave, { passive: true });
    ...
    return () => {
      ...
      eventTarget.removeEventListener('pointercancel', onLeave);
